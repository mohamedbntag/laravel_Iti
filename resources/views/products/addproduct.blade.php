...
<div class="contain">
  <div class="leftSide">
    ...
    <form action="{{route('product.store')}}" method="POST" enctype="multipart/form-data">
      ...
      <div class="form-group">
          <input type="text" name="product" class="form-control" id="product" value="{{old('product')}}"  placeholder="product">
        ...
        <div class="form-group">
          <input type="number" name="price" class="form-control" id="price" min="1" value="{{old('price')}}" placeholder="price  .... EGP">
          @error('price')
          <div style="color:red">{{$message}}</div>
            @enderror
        </div>
  ...
  <div class="rightside">
    <div class="aside"></div>
    <div class="info">
      <img class="drink1" src="/images/main/icon3.png">
      <img class="drink2" src="/images/main/icon4.png">
      <div class="icons">
